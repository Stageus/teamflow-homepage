   ...
   return (
      <div className="flex w-[300px] flex-col gap-3">
         ...
         <div className="flex justify-center gap-3 py-2">
            <Button variant={validationResult ? 'select' : 'disabeld'} onClick={()=> validationResult && console.log(privateChannelRef.current?.value)}>채널생성</Button>
            <Button variant='default' onClick={props.closeModal}>취소</Button>
         </div>
      </div>
   );
};

   ...
   return (
      <>
         <div className="flex flex-col gap-2 relative p-3">
            ...
            <div className={`${moreProfile ? moreStyle.show : moreStyle.hidden} flex gap-2 absolute bottom-0 left-0 right-0 p-2 bg-light-bg2 dark:bg-dark-bg2 translate-y-full transition-all `}>
